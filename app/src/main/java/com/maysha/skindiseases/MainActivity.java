...
import com.maysha.skindiseases.R;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void classifyImage(Bitmap image) {
        try {
            ...
            ByteBuffer outputBuffer = ByteBuffer.allocateDirect(4 * 10); // 10 floats, 4 bytes per float
            ...
            String[] classes = {"Eczema","Melanoma"," Atopic Dermatitis","Basal Cell","Melanocytic Nevi"," Benign Keratosis","Psoriasis","Seborrheic Keratoses","Tinea Ringworm","Warts Molluscum"};
